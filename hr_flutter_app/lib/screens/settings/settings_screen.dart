            ...
            Expanded(
              child: ListView(
                ...
                children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('User Id : ${profile?.id.substring(0, 12).toUpperCase() ?? ''}',
                  ...
                  // Organization
                  _Card(children: [
                    _SectionHeader(Icons.business, const Color(0xFF38BDF8), 'Organization'),
                  ...
                  // Language
                  _Card(children: [
                    _SectionHeader(Icons.translate, const Color(0xFFF59E0B), 'Language'),
                    const SizedBox(height: 8),
                    _NavRow('English'),
                  ]),
                  const SizedBox(height: 16),
                  // Privacy & Security
                  _Card(children: [
                    _SectionHeader(Icons.lock_outline, const Color(0xFFEF4444), 'Privacy & Security'),
                    const SizedBox(height: 8),
                    _NavRow('App Lock'),
                  ...
                  // About
                  _Card(children: [
                    _SectionHeader(Icons.info_outline, AppColors.blue, 'About'),
                    const SizedBox(height: 8),
                    _NavRow('About Us (1.0.0)'),
                    _NavRow('Take A Tour'),
                    _PlainRow('Rate Us'),
                    _PlainRow('Feedback'),
                    _ToggleRow('Shake for feedback', _shakeForFeedback,
                        (v) => setState(() => _shakeForFeedback = v)),
                  ]),
                  const SizedBox(height: 16),
                  // Others
                  _Card(children: [
                    _SectionHeader(Icons.more_horiz, const Color(0xFF22C55E), 'Others'),
                    const SizedBox(height: 8),
                    ...
                    _ToggleRow('Disable Haptic Feedback', _disableHaptic,

...
export const ROLES = {
  ...
  FINANCE:   'finance',
  EMPLOYEE:  'employee',
  CANDIDATE: 'candidate',  // Consultant / Candidate portal
  ACCOUNTS:  'accounts',   // Accounts / billing team
};
...
export const PERMISSION_MATRIX = {
  dashboard: {
    ...
    [ROLES.CANDIDATE]: PERMISSION_LEVELS.NONE,
    [ROLES.ACCOUNTS]:  PERMISSION_LEVELS.VIEW,
  },
  pipeline: {
    [ROLES.ADMIN]:     PERMISSION_LEVELS.FULL,
    ...
    [ROLES.CANDIDATE]: PERMISSION_LEVELS.NONE,
    [ROLES.ACCOUNTS]:  PERMISSION_LEVELS.NONE,
  },
  candidates: {
    [ROLES.ADMIN]:     PERMISSION_LEVELS.FULL,
    [ROLES.SALES]:     PERMISSION_LEVELS.VIEW,
  ...
  submissions: {
    [ROLES.ADMIN]:     PERMISSION_LEVELS.FULL,
    [ROLES.SALES]:     PERMISSION_LEVELS.FULL,
    [ROLES.RECRUITER]: PERMISSION_LEVELS.OWN,   // edit/view only their own
    [ROLES.HR]:        PERMISSION_LEVELS.NONE,
    [ROLES.FINANCE]:   PERMISSION_LEVELS.NONE,
    [ROLES.EMPLOYEE]:  PERMISSION_LEVELS.NONE,
    [ROLES.CANDIDATE]: PERMISSION_LEVELS.NONE,
  ...
  placements: {
    [ROLES.ADMIN]:     PERMISSION_LEVELS.FULL,
    [ROLES.SALES]:     PERMISSION_LEVELS.FULL,
    [ROLES.RECRUITER]: PERMISSION_LEVELS.OWN,   // view own placements
    [ROLES.HR]:        PERMISSION_LEVELS.VIEW,
    [ROLES.FINANCE]:   PERMISSION_LEVELS.VIEW,
    [ROLES.EMPLOYEE]:  PERMISSION_LEVELS.NONE,
    [ROLES.CANDIDATE]: PERMISSION_LEVELS.NONE,
  ...
  'hr-onboarding': {
    ...
    [ROLES.RECRUITER]: PERMISSION_LEVELS.OWN,   // view their candidates' onboarding
    [ROLES.HR]:        PERMISSION_LEVELS.FULL,
    [ROLES.FINANCE]:   PERMISSION_LEVELS.NONE,
    [ROLES.EMPLOYEE]:  PERMISSION_LEVELS.OWN,
    [ROLES.CANDIDATE]: PERMISSION_LEVELS.OWN,   // own docs: NCA, W9, I-9, E-verify
    [ROLES.ACCOUNTS]:  PERMISSION_LEVELS.NONE,
  },
  payroll: {
    [ROLES.ADMIN]:     PERMISSION_LEVELS.FULL,
    [ROLES.SALES]:     PERMISSION_LEVELS.NONE,
    [ROLES.RECRUITER]: PERMISSION_LEVELS.OWN,   // view own timesheets
    [ROLES.HR]:        PERMISSION_LEVELS.VIEW,
    [ROLES.FINANCE]:   PERMISSION_LEVELS.FULL,
    [ROLES.EMPLOYEE]:  PERMISSION_LEVELS.OWN,
    [ROLES.CANDIDATE]: PERMISSION_LEVELS.OWN,   // upload & view own timesheets
    [ROLES.ACCOUNTS]:  PERMISSION_LEVELS.VIEW,
  },
  invoices: {
    [ROLES.ADMIN]:     PERMISSION_LEVELS.FULL,
    [ROLES.SALES]:     PERMISSION_LEVELS.NONE,
    [ROLES.RECRUITER]: PERMISSION_LEVELS.OWN,   // view invoices for their placements
    [ROLES.HR]:        PERMISSION_LEVELS.NONE,
    [ROLES.FINANCE]:   PERMISSION_LEVELS.FULL,
    [ROLES.EMPLOYEE]:  PERMISSION_LEVELS.NONE,
    [ROLES.CANDIDATE]: PERMISSION_LEVELS.NONE,
    [ROLES.ACCOUNTS]:  PERMISSION_LEVELS.FULL,
  },
  compliance: {
    [ROLES.ADMIN]:     PERMISSION_LEVELS.FULL,
    [ROLES.SALES]:     PERMISSION_LEVELS.NONE,
  ...
  reports: {
    [ROLES.ADMIN]:     PERMISSION_LEVELS.FULL,
    [ROLES.SALES]:     PERMISSION_LEVELS.VIEW,
    [ROLES.RECRUITER]: PERMISSION_LEVELS.OWN,  // own performance reports only
    [ROLES.HR]:        PERMISSION_LEVELS.NONE,
    [ROLES.FINANCE]:   PERMISSION_LEVELS.NONE,
    [ROLES.EMPLOYEE]:  PERMISSION_LEVELS.NONE,
    [ROLES.CANDIDATE]: PERMISSION_LEVELS.NONE,
  ...
  profile: {
    ...
    [ROLES.CANDIDATE]: PERMISSION_LEVELS.FULL,
    [ROLES.ACCOUNTS]:  PERMISSION_LEVELS.FULL,
  },
  'account-settings': {
    [ROLES.ADMIN]: PERMISSION_LEVELS.FULL,

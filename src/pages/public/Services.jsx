  ...
  const services = [
    {
      ...
      description: 'End-to-end recruitment services for technology professionals across all skill levels and specializations.'
    },
    {
      icon: 'Briefcase',
      title: 'Contract Staffing',
      description: 'Flexible contract staffing solutions with comprehensive candidate management and placement tracking.'
    },
    {
      icon: 'Building2',
      title: 'Permanent Placement',
      description: 'Full-time placement services with thorough candidate vetting and long-term placement support.'
    },
    {
      icon: 'DollarSign',
      title: 'Payroll Management',
      description: 'Complete payroll processing with automated invoicing, timesheet management, and tax compliance.'
    },
    {
      icon: 'FileCheck',
      title: 'Compliance Services',
      description: 'I-9 verification, E-Verify processing, W-2 generation, and complete regulatory compliance management.'
    },
    {
      icon: 'Globe',
      title: 'Visa Sponsorship',
      description: 'H-1B, Green Card, and other visa sponsorship support with comprehensive tracking and documentation.'
    }
  ];
